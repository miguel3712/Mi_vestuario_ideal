...
public class Almacenar_Elegante : MonoBehaviour
{
    public int Contador;
    ...
    void Update()
    {
        ...
        {
            Debug.Log("El orden es correcto, Elegante");

            SceneManager.LoadScene("Vic_Ele_Sr");
        }
        else if (Contador == 5 && Orden == false)
        {
            Debug.Log("El orden es incorrecto, Elegante");


            SceneManager.LoadScene("Per_Ele_Sr");
        }
